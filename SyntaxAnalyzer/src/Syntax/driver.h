...
/** \file driver.h Declaration of the example::HybridWalkår class. */
 ...
 * example::Parser, example::Scanner and example::HybridWalkår */
namespace example {

/** The HybridWalkår class brings together all components. It creates an instance of
...
public:
    ...
    HybridWalkår(std::istream &input
			, std::ostream &output
			, std::ostream &errors
			, std::ostream &ids);
