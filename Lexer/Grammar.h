...
namespace example {
  ...
  public:
   ...
   enum yytokentype {
     ...
     Have_sign = 290,
     REFERENCE = 291,
     COMMAND_SEPARATOR = 292,
     VARIABLE_SEPARATOR = 293,
     ONLY_STRING_COMMENT = 294,
     MULTI_STRING_COMMENT = 295,
     START_IDENTIFICATION = 296,
     END_IDENTIFICATION = 297,
     NAME_INTEGER = 298,
     NAME_FLOAT = 299,
     NAME_CHAR = 300,
     NAME_STRING = 301,
     ...
     NAME_RETURN = 317,
     START_LIST_ARGUMENTS = 318,
     END_LIST_ARGUMENTS = 319,
     EQUALS = 320,
     NOT = 321,
     OR = 322,
     AND = 323,
