...
namespace example {
  ...
  public:
   ...
   enum yytokentype {
     ...
     Have_sign = 291,
     REFERENCE = 292,
     COMMAND_SEPARATOR = 293,
     VARIABLE_SEPARATOR = 294,
     ONLY_STRING_COMMENT = 295,
     MULTI_STRING_COMMENT = 296,
     START_IDENTIFICATION = 297,
     END_IDENTIFICATION = 298,
     NAME_INTEGER = 299,
     NAME_FLOAT = 300,
     NAME_CHAR = 301,
     NAME_STRING = 302,
