...
namespace example {
  ...
  public:
   ...
   enum yytokentype {
     ...
     Have_sign = 296,
     REFERENCE = 297,
     COMMAND_SEPARATOR = 298,
     VARIABLE_SEPARATOR = 299,
     ONLY_STRING_COMMENT = 300,
     MULTI_STRING_COMMENT = 301,
     START_IDENTIFICATION = 302,
     END_IDENTIFICATION = 303,
     ID = 304,
     NAME_INTEGER = 305,
     NAME_FLOAT = 306,
     NAME_CHAR = 307,
     ...
     FOR_OPERATOR = 321,
     BREAK_OPERATOR = 322,
     CONTINUE_OPERATOR = 323,
     NAME_RETURN = 324,
     START_LIST_ARGUMENTS = 325,
     END_LIST_ARGUMENTS = 326,
     EQUALS = 327,
     NOT = 328,
     OR = 329,
     AND = 330
